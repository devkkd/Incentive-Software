...
export default function Header_branch({ onMenuClick = () => {} }) {
  ...
  return (
    <header className="h-[72px] bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-8 shrink-0 relative z-20">
