...
export default function Sidebar_branch() {
  ...
  const navItems = [
    ...
    { 
      ...
      href: '/branch/wallets', 
      isActive: pathname?.startsWith('/branch/wallets'),
      icon: <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0zM15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" /> 
    },
    { 
      name: 'Reports', 
      href: '/branch/reports', 
