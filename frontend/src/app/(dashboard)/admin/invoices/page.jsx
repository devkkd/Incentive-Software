    ...
    <div className="relative" ref={ref}>
      <button
        ...
        className={`flex items-center justify-between min-w-[120px] px-4 py-2 bg-white border text-[13px] rounded-lg transition-colors ${
          isOpen
            ? 'border-[#2B3B8A] ring-1 ring-[#2B3B8A]'
      ...
      {isOpen && (
        <div className="absolute top-full mt-1.5 left-0 w-full min-w-[160px] bg-white border border-gray-100 rounded-lg shadow-lg py-1.5 z-50">
          <button
            ...
            className="w-full text-left px-4 py-2 text-[13px] text-gray-500 italic hover:bg-gray-50"
          >
            Clear Filter
          </button>
    ...
    <div className="p-8 md:p-10 max-w-[1600px] mx-auto">
      <div className="mb-6">
        <h2 className="text-[14px] text-gray-700 mb-1">
          Welcome to Friends Trading Corporation -
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-sm font-medium text-gray-700 mr-2">
              ...
              <button
                onClick={downloadPDF}
                className="bg-[#E74C3C] hover:bg-red-600 text-white text-[10px] font-bold px-1.5 py-1 rounded transition-colors"
              >
                PDF
              </button>
              ...
              <button
                ...
                className="bg-[#2ECC71] hover:bg-green-600 text-white text-[10px] font-bold px-1.5 py-1 rounded transition-colors"
              >
                XLS
              </button>
            </div>
        ...
        <div className="overflow-x-auto pb-4">
          <table className="w-full text-left whitespace-nowrap">
            <thead>
              <tr className="border-b-2 border-gray-100 text-gray-900 text-[13px]">
                <th className="pb-4 font-bold px-2">
                  #
                </th>
                ...
                <th className="pb-4 font-bold px-2 text-center">
                  Action
                </th>
              </tr>
            </thead>
              ...
              {loading ? (
                ...
                invoices.map((row, index) => (
                  ...
                  >
                    ...
                    <td className="py-5 px-2 font-semibold text-[#2B3B8A]">
                      {row.vendor
                        ?.accountNumber || '—'}
                    </td>
                    ...
                    <td className="py-5 px-2 text-center">
                      <button
                        ...
                        className="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-lg text-[12px] font-medium transition-colors"
                      >
                        Delete
                      </button>
                    </td>
                ...
                <button
                  ...
                  className={`w-8 h-8 flex items-center justify-center rounded-lg text-[13px] font-semibold transition-colors ${
                    p === pagination.page
                      ...
                      : 'bg-[#8492A6] text-white hover:bg-gray-500'
                  }`}
                >
                  {String(p).padStart(
                    2,
