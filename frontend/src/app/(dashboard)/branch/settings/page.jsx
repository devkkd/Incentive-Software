              ...
              <div className="w-full lg:w-1/3 p-8 md:p-10 border-b lg:border-b-0 lg:border-r border-gray-100 flex flex-col">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-[120px_1fr] gap-4">
                    ...
                    <span className="text-[14px] font-bold text-gray-900">Incentive Management - Jodhpur Division</span>
                  </div>
                  <div className="grid grid-cols-[120px_1fr] gap-4">
                    <span className="text-[14px] text-gray-600">Account Email</span>
                    <span className="text-[14px] font-bold text-gray-900">jodhpur-ms@gmail.com</span>
                  </div>
                  <div className="grid grid-cols-[120px_1fr] gap-4">
                  ...
                  {isOtpSent && (
                    <div className="pt-6 animate-in fade-in slide-in-from-top-4 duration-300">
                      ...
                      <p className="text-[13px] text-gray-700 leading-relaxed mb-4">
                        We sent a verification code to <span className="font-bold text-black">{newEmail}</span>. 
                      ...
                      <div className="flex gap-2 mb-2">
                        {otp.map((digit, index) => (
                          <input
                            ...
                            className="w-full aspect-[4/5] max-w-[50px] text-center text-lg font-medium border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2B3B8A] focus:border-transparent transition-all bg-white"
                          />
                        ))}
                      </div>
