...
const InputField = ({ label, id, type = 'text', placeholder, value, onChange, error, hint, required = false }) => (
  <div className="space-y-1.5">
    ...
    <input
      ...
      className={`w-full px-4 py-3 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-[#2B3B8A] focus:border-transparent transition-colors placeholder:text-gray-400 ${
        error ? 'border-[#E74C3C] bg-red-50' : 'border-gray-200'
      }`}
    />
    ...
    <div className="p-8 md:p-10 max-w-[1600px] mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 text-[13px] text-gray-500 mb-3">
          <Link href="/branch/vendors" className="hover:text-[#2B3B8A] transition-colors">Vendors</Link>
      ...
      <form onSubmit={handleSubmit}>
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            {/* Left Column: Company & Account Info */}
            <div className="w-full lg:w-1/2 p-8 md:p-10 border-b lg:border-b-0 lg:border-r border-gray-100">
              ...
              <div className="space-y-5">
                ...
                <InputField
                  ...
                  id="companyName"
                  placeholder="e.g. Sharma Auto Parts Pvt Ltd"
                ...
                <InputField
                  label="Full Address"
                  id="address"
                  placeholder="e.g. 100, MG Road, Jodhpur, Rajasthan"
                  value={form.address}
            ...
            <div className="w-full lg:w-1/2 p-8 md:p-10">
              ...
              <div className="space-y-5">
                <InputField
                  ...
                  hint="10-digit mobile number — used for OTP during redemption"
                  required
                />
                <InputField
                  label="Email Address"
          ...
          <div className="border-t border-gray-100 p-6 bg-[#F8FAFC] flex flex-col sm:flex-row items-center justify-between gap-4">
            <Link
              href="/branch/vendors"
              className="text-[14px] font-semibold text-gray-600 hover:text-gray-900 flex items-center gap-2 transition-colors"
            >
            ...
            <button
              type="submit"
              disabled={loading}
              className={`font-semibold px-10 py-3 rounded-xl flex items-center gap-2 transition-all ${
                loading
                  ? 'bg-[#8492A6] text-white cursor-not-allowed'
