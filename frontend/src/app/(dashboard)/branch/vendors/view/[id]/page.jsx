      ...
      <div className="flex h-screen bg-[#EAF2F9] font-sans text-gray-900">
        <main className="flex-1 p-8 flex items-center justify-center">
          <div className="text-center">
            ...
            <button onClick={() => router.push('/branch/vendors')} className="text-[#2B3B8A] hover:underline font-medium">
              ← Back to Vendors
            </button>
          </div>
        </main>
                ...
                <div className="px-8 py-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <div className="flex gap-3">
                    <Link 
                      ...
                      className="bg-[#2196F3] hover:bg-[#1976D2] text-white px-6 py-2.5 rounded-xl text-sm font-semibold transition-colors"
                    >
                      Edit Account
                    </Link>
                    <button 
                ...
                <div className="p-4 sm:p-8 flex flex-col lg:flex-row gap-10">
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 border-r border-gray-100 pr-0 lg:pr-10">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <span className="text-[14px] text-gray-600">Party Contact Number</span>
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-2 gap-4">
                        <span className="text-[14px] text-gray-600">Party Address</span>
