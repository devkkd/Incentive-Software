...
const translations = {
  en: {
    ...
    welcomeMsg: 'Welcome to Friends Trading Corporation - Incentive Management',

    // Sidebar
    dashboard: 'Dashboard',
    allInvoicesSidebar: 'All Invoices',
    allVendorsSidebar: 'Party List',
    allBranchesSidebar: 'Create Branch',
    allDivisionsSidebar: 'Manage Branch',
    ...
    // Vendors
    allVendors: 'Party List',
    createVendor: 'Create Party',
    importExcel: 'Import Excel',
    template: 'Template',
    companyName: 'Party Name',
    personName: 'Contact Person',
    accountNo: 'Party Code',
    mobile: 'Mobile Number',
    salesPerson: 'Salesperson',
    walletAvailable: 'Current Balance',
    lastRedemption: 'Last Redemption',
    vendorCompanyName: 'Party Name',
  ...
  hi: {
    ...
    allBranchesSidebar: 'शाखा बनाएं',
    allDivisionsSidebar: 'शाखा प्रबंधन',
